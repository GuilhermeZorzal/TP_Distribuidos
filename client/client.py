...
def funcao_generica(String, func = 'cadastrar'):
    ...
    try:
        if func == 'cadastrar':
            ...
            if func == "criar_loja":
                mensagem = {"funcao": func, "dados": {"nome": String[0], "contato": String[1], "descricao": String[2]}}
                ...
                mensagem = {"funcao": func, "dados": {"nome_servico": String[0], "descricao_servico": String[1], "categoria": String[2], "tipo_pagamento": String[3], "quantidade_pagamento": String[4], "esta_visivel": String[5]}}
                ...
                mensagem = {"funcao": func, "dados": {"categorias":categorias, "idLoja": idLoja, "cont_pages": String[-2]}}
            
            elif func == "get_servico":
                mensagem = {"funcao": func, "dados": {"idServico": String[0]}}
            
            elif func == "add_pedido":
                mensagem = {"funcao": func, "dados": {"idServico": String[0], "quantidade": String[1]}}
